...
add-highlighter shared/ligi/code/ regex \b(?<!@)(using|const|property|field|alias|let|cvar|var|extern|packed|export|pub|inline|comptime|block|overload|distinct|struct|enum|union|array|ref|slice|pure|assert|break|return|continue|if|elif|finally|else|and|or|xor|not|in|while|dowhile|for|loop|when|fn|macro|use|volatile|concept|defer|notin|is|test)\b 0:keyword
...
add-highlighter shared/ligi/code/ regex '#' 0:string
