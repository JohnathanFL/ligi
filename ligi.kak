...
add-highlighter shared/ligi/code/ regex \b(const|property|field|alias|let|cvar|var|extern|packed|export|pub|noalias|inline|comptime|nakedcc|stdcallcc|atomic|volatile|align|section)\b 0:keyword
